...
const App = () => {
  ...
  const handleArticleSwitch = (articleNumber: number) => {
    const ArticleNowSelected = articles[articleNumber];
    if (ArticleNowSelected.body && ArticleNowSelected.title) {
      setSelectedArticle(ArticleNowSelected);
    }
  };
  return (
        ...
        <div className="w-4/12">
          <div className="px-4 py-2 w-full">
            <div className="mx-auto w-full max-w-md">
              <SearchBar
                contents={articles}
                handleSelect={handleArticleSwitch}
              />
            </div>
          </div>
        </div>
